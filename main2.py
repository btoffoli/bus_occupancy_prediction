...
def main():
    ...
    if args.mode == 'vehiclerun':
        ...
        db_config = {
            'dbname': args.db_name or os.getenv('DB_NAME_PONTUAL'),
            'user': args.db_user or os.getenv('DB_USER_PONTUAL'),
            'password': args.db_password or os.getenv('DB_PASSWORD_PONTUAL'),
            'host': args.db_host or os.getenv('DB_HOST_PONTUAL'),
            'port': args.db_port or os.getenv('DB_PORT_PONTUAL')
        }
        print(f"db_config: {db_config}")
        db_service = DatabaseServicePontual(db_config)
        db_service.run()
